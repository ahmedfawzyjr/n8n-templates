...
def generate_readme(categories_data, total_templates):
    ...
    lines.append('[![CI](https://github.com/ahmedfawzyjr/N8N-Templates/actions/workflows/ci.yml/badge.svg)](https://github.com/ahmedfawzyjr/N8N-Templates/actions)')
    lines.append('[![Security Policy](https://img.shields.io/badge/Security-Policy-blue.svg?style=flat-square)](SECURITY.md)')
    lines.append('[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)')
    lines.append('')
    lines.append('---')
    lines.append('')
