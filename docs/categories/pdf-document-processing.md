...
<div class="templates-grid" style="margin-top: 24px;">
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates chain Llm, OpenAI Chat, output Parser Structured, Google Sheets for reliable automated execution.</p>
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates chain Retrieval Qa, chat  (Trigger), document Default Data Loader, embeddings Open Ai for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates chain Llm, chain Retrieval Qa, chain Summarization, document Default Data Loader for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Autonomous support automation workflow connecting chain Llm, chat  (Trigger), document Default Data Loader, embeddings Open Ai. Implements intelligent data retrieval, AI reasoning, and instant responses.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates HTTP Request, limit, manual  (Trigger), no Op for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end hr automation template for PDF & Document Processing. Integrates chain Llm, Gemini, output Parser Structured, edit Image for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates cron, google Cloud Natural Language, MongoDB, no Op for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates Extract from File, Google Drive, HTTP Request, manual  (Trigger) for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end hr automation template for PDF & Document Processing. Integrates chain Llm, OpenAI Chat, output Parser Autofixing, output Parser Structured for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates chain Llm, Gemini, convert To File, Extract from File for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates chain Llm, lm Chat Open Router, form, n8n Form Trigger for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end finance automation template for PDF & Document Processing. Integrates chain Llm, lm Open Ai, output Parser Structured, aggregate for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end engineering automation template for PDF & Document Processing. Integrates dropbox, execute Workflow  (Trigger), HTTP Request, manual  (Trigger) for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates Airtable, Google Drive, Google Drive Trigger, HTTP Request for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Production-grade finance workflow for automated data synchronization and pipeline processing using cradl Ai, Gmail, Gmail Trigger, Google Sheets.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates item Lists, manual  (Trigger), move Binary Data, OpenAI for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates open Ai, Extract from File, Google Drive, Google Drive Trigger for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates chain Llm, information Extractor, Gemini, aggregate for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates open Ai, Google Drive, Google Drive Trigger, Notion for reliable automated execution.</p>
      <div class="card-nodes-list">
