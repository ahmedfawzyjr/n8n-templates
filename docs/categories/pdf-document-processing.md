...
<div class="templates-grid" style="margin-top: 24px;">
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates output Parser Structured, Google Sheets, Slack, Respond to Webhook for reliable automated execution.</p>
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates chain Retrieval Qa, manual  (Trigger), embeddings Open Ai, Google Drive for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates wait, embeddings Mistral Cloud, Qdrant, lm Chat Mistral Cloud for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Autonomous support automation workflow connecting output Parser Structured, manual  (Trigger), embeddings Open Ai, Google Drive. Implements intelligent data retrieval, AI reasoning, and instant responses.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates wait, no Op, split Out, manual  (Trigger) for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end hr automation template for PDF & Document Processing. Integrates output Parser Structured, manual  (Trigger), Gemini, edit Image for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates no Op, MongoDB, cron, google Cloud Natural Language for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates manual  (Trigger), Google Drive, HTTP Request, sticky Note for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end hr automation template for PDF & Document Processing. Integrates output Parser Structured, convert To File, no Op, Merge for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates convert To File, Switch, Gemini, Google Drive for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates lm Chat Open Router, form, chain Llm, n8n Form Trigger for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end finance automation template for PDF & Document Processing. Integrates output Parser Structured, wait, Gmail Trigger, Google Sheets for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end engineering automation template for PDF & Document Processing. Integrates wait, manual  (Trigger), Switch, dropbox for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates Airtable, Google Drive, HTTP Request, sticky Note for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Production-grade finance workflow for automated data synchronization and pipeline processing using Google Sheets, Gmail Trigger, split Out, cradl Ai.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates OpenAI, item Lists, manual  (Trigger), spreadsheet File for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates split Out, open Ai, Merge, Google Drive for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates Compression (Zip), sort, manual  (Trigger), Gemini for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for PDF & Document Processing. Integrates open Ai, Google Drive, Notion, sticky Note for reliable automated execution.</p>
      <div class="card-nodes-list">
