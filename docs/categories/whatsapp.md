...
<div class="templates-grid" style="margin-top: 24px;">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Production-grade sales workflow for automated data synchronization and pipeline processing using Google Sheets, HTTP Request, sticky Note.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Production-grade finance workflow for automated data synchronization and pipeline processing using Google Sheets, HTTP Request, sticky Note.</p>
      <div class="card-nodes-list">
        <span class="node-tag">Code JS/Python</span><span class="node-tag">Google Sheets</span><span class="node-tag">HTTP Request</span> <span class="node-tag">+2</span>
      </div>
      <div class="card-actions">
