...
<div class="templates-grid" style="margin-top: 24px;">
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Autonomous hr automation workflow connecting split Out, HTML Extract, Respond to Webhook, sticky Note. Implements intelligent data retrieval, AI reasoning, and instant responses.</p>
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Real-time event-driven operations alert and notification workflow leveraging tool Wikipedia, open Ai, sticky Note, filter.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end sales automation template for Forms & Surveys. Integrates OpenAI Chat, text Classifier, sticky Note, form for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for Forms & Surveys. Integrates HTTP Request, wait, n8n Form Trigger for reliable automated execution.</p>
      <div class="card-nodes-list">
