...
<div class="templates-grid" style="margin-top: 24px;">
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Autonomous hr automation workflow connecting redis, memory Manager, Crypto / Hash, Google Sheets. Implements intelligent data retrieval, AI reasoning, and instant responses.</p>
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Real-time event-driven operations alert and notification workflow leveraging AI Agent, edit Image, execution Data, Gmail.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end sales automation template for Forms & Surveys. Integrates text Classifier, Gmail, Execute Workflow, n8n Form Trigger for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for Forms & Surveys. Integrates wait, HTTP Request, n8n Form Trigger for reliable automated execution.</p>
      <div class="card-nodes-list">
