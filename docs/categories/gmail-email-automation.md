...
<div class="templates-grid" style="margin-top: 24px;">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Real-time event-driven operations alert and notification workflow leveraging Read Email (IMAP), filter, HTTP Request.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">Real-time event-driven sales alert and notification workflow leveraging Google Sheets, OpenAI, Respond to Webhook, sticky Note.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end operations automation template for Gmail & Email Automation. Integrates AI Agent, Gemini, HTML Extract, HTTP Request for reliable automated execution.</p>
      <div class="card-nodes-list">
