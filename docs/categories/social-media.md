...
<div class="templates-grid" style="margin-top: 24px;">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end marketing automation template for Instagram, Twitter, Social Media. Integrates HTTP Request, manual  (Trigger) for reliable automated execution.</p>
      <div class="card-nodes-list">
  ...
  <div class="template-card">
    <div class="template-card-inner">
      ...
      <p class="card-desc">End-to-end marketing automation template for Instagram, Twitter, Social Media. Integrates Google Sheets, OpenAI, Respond to Webhook, sticky Note for reliable automated execution.</p>
      <div class="card-nodes-list">
